...
import com.bekkestad.examples.tutorial.model.OrderEntity;
import com.bekkestad.examples.tutorial.model.ProductDAO;
import com.bekkestad.examples.tutorial.model.ProductEntity;
import com.bekkestad.examples.tutorial.repository.OrderRepository;
import com.bekkestad.examples.tutorial.repository.OrderRepositoryImpl;
import com.bekkestad.examples.tutorial.service.ShoppingCartService;
import com.bekkestad.examples.tutorial.service.ShoppingCartServiceImpl;
	...
	public static Archive<?> createDeployment(){
		return ShrinkWrap.create(WebArchive.class, "test.war")
				.addClasses(ShoppingCartService.class, ShoppingCartServiceImpl.class, 
						ProductDAO.class, OrderDAO.class, OrderEntity.class, ProductEntity.class, 
